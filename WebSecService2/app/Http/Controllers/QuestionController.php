...
class QuestionController extends Controller
{
    ...
    {
        $questions = Question::latest()->paginate(10); // Pagination لعرض 10 أسئلة فقط في الصفحة
    ...
    public function store(Request $request)
{
    ...
    public function update(Request $request, Question $question)
    {
        ...
        return redirect()->route('questions.index')->with('success', 'MCQ Updated Successfully!');
    }
    ...
    public function destroy(Question $question)
    {
        ...
        return redirect()->route('questions.index')->with('success', 'MCQ Deleted Successfully!');
    }
}
